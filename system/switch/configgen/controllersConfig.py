...
from configgen.batoceraPaths import BATOCERA_ES_DIR, ES_GAMES_METADATA, USER_ES_DIR

if TYPE_CHECKING:

    from configgen.types import DeviceInfoDict, DeviceInfoMapping, GunDict, GunMapping
