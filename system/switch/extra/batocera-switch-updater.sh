...
version="0.0.2"
wget -q --show-progress --tries=10 --no-check-certificate --no-cache --no-cookies -O "/userdata/system/switch/eden.AppImage" "https://github.com/eden-emulator/Releases/releases/download/v0.0.2-pre-alpha/Eden-Linux-0.0.2-pre-alpha-amd64.AppImage"
